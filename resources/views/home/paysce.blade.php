            ...
            <div id="TopTools" class="TopToolsFlow" style=" height:24px; background:#fdfdfd; border-bottom:1px solid #e9e9e9;">
                <div class="headBox">
                    ...
                    <div class="TopToolsRight f_r">
                        <ul>
                            <script type="text/javascript" src="js/jquery-1_1.js"></script>
                            <script type="text/javascript" src="js/jquery_002_1.js"></script>
                            <script type="text/javascript" src="js/jquery_1.js"></script>
                            <script type="text/javascript" src="js/transport_jquery_1.js"></script>
                            <script type="text/javascript" src="js/utils_2.js"></script>
                            <script type="text/javascript" src="js/ecmoban_common_1.js"></script>
                            <li>
            ...
            <div class="buytab_a">
                <div class="nstep2_con orderok">
                    ...
                    <p style="text-align:center; margin-bottom:20px;">
                        您可以
                        <a href="http://weipin.ecshop119.com/index.php">
                            返回首页
                        </a>
                        或去
                        <a href="http://weipin.ecshop119.com/user.php">
